...
CREATE TABLE "Job" (
    ...
    "job_detailsJobId" INTEGER NOT NULL,
...
CREATE TABLE "applicant_status" (
    "id" SERIAL NOT NULL,
    "name" "ApplicantStatus" NOT NULL DEFAULT 'NOT_LOOKING',
...
CREATE TABLE "professional_details" (
    ...
    "interests" TEXT[],
    "salaryRange" TEXT NOT NULL,
    "experienceLevel" "ApplicantExperienceLevel" NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Job_job_detailsJobId_key" ON "Job"("job_detailsJobId");
...
-- AddForeignKey
ALTER TABLE "Job" ADD CONSTRAINT "Job_job_detailsJobId_fkey" FOREIGN KEY ("job_detailsJobId") REFERENCES "job_details"("jobId") ON DELETE RESTRICT ON UPDATE CASCADE;
